...
func ReconcileServiceMonitor(ctx reconciler.Context, cluster *v1alpha1.BookkeeperCluster) (err error) {
	return createServiceMonitor(ctx, cluster)
}

func createServiceMonitor(ctx reconciler.Context, cluster *v1alpha1.BookkeeperCluster) error {
...
func updateStatusResourceVersion(ctx reconciler.Context,
	cluster *v1alpha1.BookkeeperCluster, sm *v12.ServiceMonitor) error {
	cluster.Status.Metadata.ServiceMonitorVersion = &sm.ResourceVersion
	return ctx.Client().Update(context.TODO(), cluster)
}

func create(cluster *v1alpha1.BookkeeperCluster) *v12.ServiceMonitor {
