...
import (
	bookkeepermonimeslv1alpha1 "github.com/monimesl/bookkeeper-operator/api/v1alpha1"
	"github.com/monimesl/bookkeeper-operator/controller"
...
func init() {
	...
	utilruntime.Must(bookkeepermonimeslv1alpha1.AddToScheme(scheme))
